...
public class TestBinTreeUtil extends TestCase {
	...
	BTNode(int id) { this(id, null, null); }
	public final int id;
	...
	return new Pair<BTNode,BinTreeNavigator<BTNode>>
		...
		public BTNode left(BTNode node)  { return node.left; }
		public BTNode right(BTNode node) { return node.right; }
	    });
    }
